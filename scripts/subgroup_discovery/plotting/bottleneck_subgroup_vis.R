...
for(metric in metric_order){
    ...
    bottleneck_spreadsheet <- paste0("./results/subgroup_discovery/subgroup_",metric,"_bottleneck_results.xlsx")
    ...
    pdf(paste0("./results/subgroup_discovery/bottleneck_",metric,"_kfold_PR_curves.pdf"), height=7, width=7, useDingbats=FALSE)
    print(PR_combined_plot)
    dev.off()

    pdf(paste0("./results/subgroup_discovery/bottleneck_",metric,"_val_PR_curves.pdf"), height=7, width=7, useDingbats=FALSE)
    ...
    pdf(paste0("./results/subgroup_discovery/bottleneck_",metric,"_ROC_curves.pdf"), height=7, width=7, useDingbats=FALSE)
    print(ROC_combined_plot)
    dev.off()

    pdf(paste0("./results/subgroup_discovery/bottleneck_",metric,"_val_ROC_curves.pdf"), height=7, width=7, useDingbats=FALSE)
