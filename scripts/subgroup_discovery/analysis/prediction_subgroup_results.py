...
for metric in evaluation_order:
    ...
    #
    #save to file
    with open("./results/subgroup_discovery/subgroup_"+metric+"_prediction_results.pkl", "wb") as f:
    ...
    #
    #initialize writer
    # TODO: Specify the outputs for the prediction results workgroup
    workbook = xlsxwriter.Workbook("./results/subgroup_discovery/subgroup_"+metric+"_prediction_results.xlsx")
